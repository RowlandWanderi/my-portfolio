...
const data = [
    ...
    {id: 4, icon: <AiFillAppstore/>, title: 'App Development', desc: "Unlike other developers in the market, I will be building an app that runs on both IOS and android devices without any extra cost to you"}
]
